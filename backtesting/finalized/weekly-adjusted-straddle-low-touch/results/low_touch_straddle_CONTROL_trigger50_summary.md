...
- Total adds: `811`, total unwinds: `376`
- Add trigger fired but **no strike existed in the target band**: `331` times
- Add strike rule: `otm-spot`
- Held from the day after the previous expiry
- Contract: **weekly expiry**
- Total rolls at the leg cap: `128`
- Entry strike search: +/-`0` strikes around ATM; entries away from ATM: `0` of `329`
- Orders executed: `3194`
- Max legs open at once: `4`

| Metric | Value |
|---|---:|
| Gross P/L | Rs 809,299.65 |
| Costs | Rs 95,820.00 |
| **Net P/L** | **Rs 713,479.65** |
| CAGR | 20.76% |
| Max drawdown | Rs 80,377.50 |
| Win rate | 69.91% (230W / 99L) |
| Profit factor | 2.16 |
| Best cycle | Rs 41,118.75 |
| Worst cycle | Rs -64,331.25 |
| Final equity | Rs 1,013,479.65 |

## Yearly

| Year | Cycles | Net P/L | Win % |
|---|---:|---:|---:|
| 2020 | 52 | Rs 181,098.75 | 78.8% |
| 2021 | 52 | Rs 115,170.00 | 71.2% |
| 2022 | 52 | Rs 145,770.00 | 73.1% |
| 2023 | 51 | Rs 31,955.00 | 70.6% |
| 2024 | 51 | Rs -21,251.25 | 56.9% |
| 2025 | 53 | Rs 215,797.65 | 75.5% |
| 2026 | 18 | Rs 44,939.50 | 50.0% |
...
- Leg prices use the last traded bar at or before the check minute; `stale_prices` in the cycle CSV counts how often a carried-forward bar was used (total 217).
...
- Cycles: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci180_cycles.csv`
- Legs: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci180_legs.csv`
- Equity: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci180_equity.csv`
- Log: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci180.log`
