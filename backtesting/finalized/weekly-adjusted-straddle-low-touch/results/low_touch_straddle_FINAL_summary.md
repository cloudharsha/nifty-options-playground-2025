...
- Pricing: 1-minute option `open`; checks every 180 minute(s)
...
- Total adds: `691`, total unwinds: `259`
- Add trigger fired but **no strike existed in the target band**: `233` times
- Add strike rule: `otm-spot`
- Held from the day after the previous expiry
- Contract: **weekly expiry**
- Total rolls at the leg cap: `20`
- Entry strike search: +/-`0` strikes around ATM; entries away from ATM: `0` of `329`
- Orders executed: `2738`
- Max legs open at once: `4`

| Metric | Value |
|---|---:|
| Gross P/L | Rs 820,726.15 |
| Costs | Rs 82,140.00 |
| **Net P/L** | **Rs 738,586.15** |
| CAGR | 21.22% |
| Max drawdown | Rs 56,767.50 |
| Win rate | 69.00% (227W / 102L) |
| Profit factor | 2.22 |
| Best cycle | Rs 55,246.00 |
| Worst cycle | Rs -41,190.00 |
| Final equity | Rs 1,038,586.15 |

## Yearly

| Year | Cycles | Net P/L | Win % |
|---|---:|---:|---:|
| 2020 | 52 | Rs 152,673.75 | 73.1% |
| 2021 | 52 | Rs 107,250.00 | 67.3% |
| 2022 | 52 | Rs 142,765.00 | 76.9% |
| 2023 | 51 | Rs 28,235.00 | 70.6% |
| 2024 | 51 | Rs 20,578.00 | 56.9% |
| 2025 | 53 | Rs 232,032.15 | 77.4% |
| 2026 | 18 | Rs 55,052.25 | 44.4% |
...
- Leg prices use the last traded bar at or before the check minute; `stale_prices` in the cycle CSV counts how often a carried-forward bar was used (total 200).
...
- Cycles: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci180_trig40_cycles.csv`
- Legs: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci180_trig40_legs.csv`
- Equity: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci180_trig40_equity.csv`
- Log: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci180_trig40.log`
