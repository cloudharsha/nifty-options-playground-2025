...
| Net P/L | -Rs 511,387 |
| Gross P/L | -Rs 423,387 |
| Brokerage + slippage | Rs 88,000 |
| CAGR | -9.15% |
...
| Loss days | 767 |
| Win rate (day) | 51.2% |
| Max drawdown | Rs 1,034,800 |
| Max consec win days | 7 |
| Max consec loss days | 9 |
| Days with 2-SL cap hit | 76 |
...
|-------------|-------|---|-------|
| target_hit | 332 | 18.9% | 60% credit captured — done for day |
| premium_sl | 31 | 1.8% | GTT SL fired (counts toward cap) |
| sma_cross_exit | 1013 | 57.6% | Manual exit on SMA cross (counts toward cap) |
| day_close | 384 | 21.8% | Mandatory close at 15:15 |

## Yearly Breakdown

| Year | Traded Days | Wins | Losses | Win% | Net P/L |
|------|-------------|------|--------|------|---------|
| 2020 | 249 | 129 | 120 | 51.8% | -Rs 82,615 |
| 2021 | 245 | 129 | 116 | 52.7% | Rs 207,885 |
| 2022 | 247 | 119 | 128 | 48.2% | -Rs 273,435 |
| 2023 | 239 | 119 | 120 | 49.8% | -Rs 132,530 |
| 2024 | 246 | 123 | 123 | 50.0% | -Rs 402,910 |
| 2025 | 247 | 135 | 112 | 54.7% | Rs 123,660 |
...
| **This strategy (combined-human)** | **-9.15%** | **Rs 1,034,800** | Min-gap + premium SL + target + 15-min monitoring |
