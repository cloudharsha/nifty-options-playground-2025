...
- Cycles traded: `331` (skipped `3`)
- Total adds: `2520`, total unwinds: `2126`
- Add trigger fired but **no strike existed in the target band**: `47047` times
- Add strike rule: `otm-spot`
- Total rolls at the leg cap: `746`
- Entry strike search: +/-`5` strikes around ATM with best-balance fallback; entries away from ATM: `80` of `331`
- Orders executed: `7856`
- Max legs open at once: `4`

| Metric | Value |
|---|---:|
| Gross P/L | Rs 1,291,188.25 |
| Costs | Rs 235,680.00 |
| **Net P/L** | **Rs 1,055,508.25** |
| CAGR | 26.32% |
| Max drawdown | Rs 99,097.50 |
| Win rate | 67.67% (224W / 107L) |
| Profit factor | 2.45 |
| Best cycle | Rs 45,454.50 |
| Worst cycle | Rs -57,851.25 |
| Final equity | Rs 1,355,508.25 |

## Yearly

| Year | Cycles | Net P/L | Win % |
|---|---:|---:|---:|
| 2020 | 53 | Rs 138,873.75 | 62.3% |
| 2021 | 52 | Rs 267,685.00 | 73.1% |
| 2022 | 52 | Rs 169,102.50 | 73.1% |
| 2023 | 51 | Rs 44,847.50 | 58.8% |
| 2024 | 51 | Rs 76,351.75 | 62.7% |
| 2025 | 53 | Rs 301,230.40 | 79.2% |
| 2026 | 19 | Rs 57,417.35 | 57.9% |
...
- Leg prices use the last traded bar at or before the check minute; `stale_prices` in the cycle CSV counts how often a carried-forward bar was used (total 38126).
...
- Cycles: `adjusted_straddle_half_add_2020_2026_expiry_otm_stale_srch5_fb_cap3_cycles.csv`
- Legs: `adjusted_straddle_half_add_2020_2026_expiry_otm_stale_srch5_fb_cap3_legs.csv`
- Equity: `adjusted_straddle_half_add_2020_2026_expiry_otm_stale_srch5_fb_cap3_equity.csv`
- Log: `adjusted_straddle_half_add_2020_2026_expiry_otm_stale_srch5_fb_cap3.log`
