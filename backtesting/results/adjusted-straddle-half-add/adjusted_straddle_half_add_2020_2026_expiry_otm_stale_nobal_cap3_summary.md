...
- Total adds: `2493`, total unwinds: `2105`
- Add trigger fired but **no strike existed in the target band**: `45764` times
- Add strike rule: `otm-spot`
- Total rolls at the leg cap: `734`
- Orders executed: `7770`
- Max legs open at once: `4`

| Metric | Value |
|---|---:|
| Gross P/L | Rs 1,290,364.60 |
| Costs | Rs 233,100.00 |
| **Net P/L** | **Rs 1,057,264.60** |
| CAGR | 26.34% |
| Max drawdown | Rs 75,972.00 |
| Win rate | 66.87% (220W / 109L) |
| Profit factor | 2.59 |
| Best cycle | Rs 45,454.50 |
| Worst cycle | Rs -41,246.25 |
| Final equity | Rs 1,357,264.60 |

## Yearly

| Year | Cycles | Net P/L | Win % |
|---|---:|---:|---:|
| 2020 | 52 | Rs 184,807.50 | 65.4% |
| 2021 | 52 | Rs 265,228.75 | 73.1% |
| 2022 | 52 | Rs 168,377.50 | 73.1% |
| 2023 | 51 | Rs 52,292.50 | 58.8% |
| 2024 | 51 | Rs 64,416.75 | 60.8% |
| 2025 | 53 | Rs 273,174.00 | 73.6% |
| 2026 | 18 | Rs 48,967.60 | 55.6% |
...
- Leg prices use the last traded bar at or before the check minute; `stale_prices` in the cycle CSV counts how often a carried-forward bar was used (total 37567).
...
- Cycles: `adjusted_straddle_half_add_2020_2026_expiry_otm_stale_nobal_cap3_cycles.csv`
- Legs: `adjusted_straddle_half_add_2020_2026_expiry_otm_stale_nobal_cap3_legs.csv`
- Equity: `adjusted_straddle_half_add_2020_2026_expiry_otm_stale_nobal_cap3_equity.csv`
- Log: `adjusted_straddle_half_add_2020_2026_expiry_otm_stale_nobal_cap3.log`
