...
- Total adds: `862`, total unwinds: `662`
- Add trigger fired but **no strike existed in the target band**: `255129` times
- Add strike rule: `beyond-legs`
- Total rolls at the leg cap: `0`
- Orders executed: `2704`
- Max legs open at once: `4`

| Metric | Value |
|---|---:|
| Gross P/L | Rs 718,470.00 |
| Costs | Rs 81,120.00 |
| **Net P/L** | **Rs 637,350.00** |
| CAGR | 19.38% |
| Max drawdown | Rs 73,687.50 |
| Win rate | 64.90% (159W / 86L) |
| Profit factor | 1.64 |
| Best cycle | Rs 55,861.75 |
| Worst cycle | Rs -72,596.25 |
| Final equity | Rs 937,350.00 |

## Yearly

| Year | Cycles | Net P/L | Win % |
|---|---:|---:|---:|
| 2020 | 41 | Rs 120,450.00 | 68.3% |
| 2021 | 48 | Rs 130,260.00 | 68.8% |
| 2022 | 42 | Rs 69,370.00 | 66.7% |
| 2023 | 29 | Rs 9,325.00 | 55.2% |
| 2024 | 40 | Rs 30,727.50 | 62.5% |
| 2025 | 31 | Rs 246,027.75 | 74.2% |
| 2026 | 14 | Rs 31,189.75 | 42.9% |
...
- Leg prices use the last traded bar at or before the check minute; `stale_prices` in the cycle CSV counts how often a carried-forward bar was used (total 24880).
...
- Cycles: `adjusted_straddle_half_add_2020_2026_expiry_cap3_cycles.csv`
- Legs: `adjusted_straddle_half_add_2020_2026_expiry_cap3_legs.csv`
- Equity: `adjusted_straddle_half_add_2020_2026_expiry_cap3_equity.csv`
- Log: `adjusted_straddle_half_add_2020_2026_expiry_cap3.log`
