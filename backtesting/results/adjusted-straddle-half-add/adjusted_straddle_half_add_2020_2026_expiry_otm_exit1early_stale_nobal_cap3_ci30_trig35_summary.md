...
- Add trigger: weaker side total `<= 35%` of stronger side total
...
- Total adds: `831`, total unwinds: `400`
- Add trigger fired but **no strike existed in the target band**: `345` times
- Add strike rule: `otm-spot`
- Held from the day after the previous expiry
- Contract: **weekly expiry**
- Total rolls at the leg cap: `12`
- Entry strike search: +/-`0` strikes around ATM; entries away from ATM: `0` of `329`
- Orders executed: `3002`
- Max legs open at once: `4`

| Metric | Value |
|---|---:|
| Gross P/L | Rs 822,274.25 |
| Costs | Rs 90,060.00 |
| **Net P/L** | **Rs 732,214.25** |
| CAGR | 21.09% |
| Max drawdown | Rs 75,466.25 |
| Win rate | 62.92% (207W / 122L) |
| Profit factor | 1.67 |
| Best cycle | Rs 55,044.25 |
| Worst cycle | Rs -60,022.50 |
| Final equity | Rs 1,032,214.25 |

## Yearly

| Year | Cycles | Net P/L | Win % |
|---|---:|---:|---:|
| 2020 | 52 | Rs 102,915.00 | 63.5% |
| 2021 | 52 | Rs 168,541.25 | 71.2% |
| 2022 | 52 | Rs 131,345.00 | 63.5% |
| 2023 | 51 | Rs 47,440.00 | 58.8% |
| 2024 | 51 | Rs 1,175.50 | 54.9% |
| 2025 | 53 | Rs 265,636.00 | 71.7% |
| 2026 | 18 | Rs 15,161.50 | 44.4% |
...
- Leg prices use the last traded bar at or before the check minute; `stale_prices` in the cycle CSV counts how often a carried-forward bar was used (total 837).
...
- Cycles: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci30_trig35_cycles.csv`
- Legs: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci30_trig35_legs.csv`
- Equity: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci30_trig35_equity.csv`
- Log: `adjusted_straddle_half_add_2020_2026_expiry_otm_exit1early_stale_nobal_cap3_ci30_trig35.log`
