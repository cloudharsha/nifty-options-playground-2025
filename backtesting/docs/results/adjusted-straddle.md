...
| Current | 2020–2026 | Adjusted ATM Straddle — Half-Trigger / 25% Add — **Daily overnight roll** (enter 15:20, adjust next session, exit 15:20 next day, re-enter; 3-leg cap, adds OTM vs spot) | Profit | Rs 6.48L | Rs 4,74,838 | 8.88% CAGR | Rs 1,03,474 | [Summary](../../results/adjusted-straddle-half-add/adjusted_straddle_half_add_2020_2026_daily_otm_stale_nobal_cap3_ci60_summary.md) | 1,264 cycles, PF 1.30, win 63.7%. **Loses to the weekly even at zero cost**: gross Rs 7,38,658 is below the weekly's *net* Rs 7,93,240. Costs Rs 2,63,820 = 36% of gross, 57% of that just the mandated daily round trip. Worst cycle −Rs 70,340 |
