...
IST_SUFFIX = "+05:30"
DAYWISE_FILENAME = "short_atm_nifty_ma_weekly_overnight_2025_daywise.csv"
SUMMARY_FILENAME = "short_atm_nifty_ma_weekly_overnight_2025_summary.md"
LOG_FILENAME = "short_atm_nifty_ma_weekly_overnight_2025.log"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Backtest the 2025 overnight weekly directional ATM short option strategy using a NIFTY 25-SMA signal.",
    )
    parser.add_argument(
        "--spot-file",
        type=Path,
...
def configure_logger(log_path: Path) -> logging.Logger:
    logger = logging.getLogger("short_atm_nifty_ma_weekly_overnight_2025")
